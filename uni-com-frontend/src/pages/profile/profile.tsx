  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-card">
        <Avatar width={80} editable={true} />
        <div className="profile-info">
          <h2>{loading ? "Fetching..." : fullName}</h2>
          <p className="level">
            {loading ? "Fetching..." : `${department} - ${level} Level`}
          </p>
          <p className="joined">
            {loading ? "Fetching..." : `Joined: ${date}`}
          </p>
        </div>
      </div>
      <div className="profile-tabs">
        <button
          className={
            location.pathname === "/profile/materials"
              ? "active"
              : location.pathname !== "/profile/materials" &&
                location.pathname.startsWith("/profile/materials")
              ? "active"
              : ""
          }
